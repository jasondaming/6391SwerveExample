...
public class F3106391 {
  ...
  public F3106391(int port) {
    ...
    POVUp =
        new POVButton(m_F3106391Controller, 315)
            .or(new POVButton(m_F3106391Controller, 0))
            .or(new POVButton(m_F3106391Controller, 45));
    POVDown =
        new POVButton(m_F3106391Controller, 225)
            .or(new POVButton(m_F3106391Controller, 180))
            .or(new POVButton(m_F3106391Controller, 135));
    POVLeft =
        new POVButton(m_F3106391Controller, 225)
            .or(new POVButton(m_F3106391Controller, 270))
            .or(new POVButton(m_F3106391Controller, 315));
    POVRight =
        new POVButton(m_F3106391Controller, 45)
            .or(new POVButton(m_F3106391Controller, 90))
            .or(new POVButton(m_F3106391Controller, 135));
    ...
    LeftStickButton =
        new JoystickButton(m_F3106391Controller, F310Controller.Button.kStickLeft.value);
    RightStickButton =
        new JoystickButton(m_F3106391Controller, F310Controller.Button.kStickRight.value);
  }
