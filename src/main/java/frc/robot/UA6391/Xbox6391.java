...
public class Xbox6391 {
  ...
  public Xbox6391(int port, double deadband) {
    m_Xbox6391Controller = new XboxController(port);
    m_deadband = deadband;

    POVUpish =
        new POVButton(m_Xbox6391Controller, 315)
            .or(new POVButton(m_Xbox6391Controller, 0))
            .or(new POVButton(m_Xbox6391Controller, 45));
    POVDownish =
        new POVButton(m_Xbox6391Controller, 225)
            .or(new POVButton(m_Xbox6391Controller, 180))
            .or(new POVButton(m_Xbox6391Controller, 135));
    POVLeftish =
        new POVButton(m_Xbox6391Controller, 225)
            .or(new POVButton(m_Xbox6391Controller, 270))
            .or(new POVButton(m_Xbox6391Controller, 315));
    POVRightish =
        new POVButton(m_Xbox6391Controller, 45)
            .or(new POVButton(m_Xbox6391Controller, 90))
            .or(new POVButton(m_Xbox6391Controller, 135));
    ...
    LeftStickButton =
        new JoystickButton(m_Xbox6391Controller, XboxController.Button.kStickLeft.value);
    RightStickButton =
        new JoystickButton(m_Xbox6391Controller, XboxController.Button.kStickRight.value);
  }

  public double JoystickLX() {
    return applyDeadband(m_Xbox6391Controller.getX(GenericHID.Hand.kLeft));
  }

  public double JoystickLY() {
    return applyDeadband(m_Xbox6391Controller.getY(GenericHID.Hand.kLeft));
  }

  public double JoystickRX() {
    return applyDeadband(m_Xbox6391Controller.getX(GenericHID.Hand.kRight));
  }

  public double JoystickRY() {
    return applyDeadband(m_Xbox6391Controller.getY(GenericHID.Hand.kRight));
  }
  ...
  public double TriggerCombined() {
    return m_Xbox6391Controller.getTriggerAxis(GenericHID.Hand.kLeft) - m_Xbox6391Controller.getTriggerAxis(GenericHID.Hand.kRight);
  }
